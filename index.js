...
for(const heart of hearts){
    heart.addEventListener('click',function(e){
        ...
        const heartInitial=parseInt(document.getElementById('heart-increment').innerText);
...
for(const btn of btns){
    btn.addEventListener("click",function(e){
        e.preventDefault();
        const initialCoin=parseInt(document.getElementById('coin-decrement').innerText);
